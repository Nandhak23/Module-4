...
note: class name should be calc, function name should be setvalues( to set a and b values) ,add and mul cases :
...
ALGORITHM
    ...
    Begin the program.
    Define the Class Calc:
        Initialize the class with an init method (optional, but good practice).
